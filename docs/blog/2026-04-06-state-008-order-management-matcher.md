---
title: "April 6, 2026: State 008 - Rudimentary Order Manager and Matcher"
slug: /blog/2026-04-06-state-008-order-management-matcher
---

# State 008: Rudimentary Order Manager and Matcher

State `008-order-management-matcher` introduces a deliberately simple order-management model to demonstrate architecture and flow shape, not market microstructure correctness.
...
## Messaging Architecture (State 008)
...
- Learning guide: [/docs/learning/state-008-order-management-matcher](/docs/learning/state-008-order-management-matcher)
- Generated code branch: [code/generated-state-008-order-management-matcher](https://github.com/finos/traderX/tree/code/generated-state-008-order-management-matcher)
- Compare vs parent (`007`): [code/generated-state-007-pricing-awareness-market-data...code/generated-state-008-order-management-matcher](https://github.com/finos/traderX/compare/code%2Fgenerated-state-007-pricing-awareness-market-data...code%2Fgenerated-state-008-order-management-matcher)
