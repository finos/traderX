---
title: ADR-005 Use NATS for State 005 Messaging Replacement
slug: /adr/005-state-005-use-nats-for-messaging-replacement
status: accepted
date: 2026-03-31
...
# Use NATS as the Messaging Backbone in State 005
...
State `005-messaging-nats-replacement` introduces a core architecture-track step after state `004-postgres-database-replacement`. We needed a lightweight but robust messaging foundation that remains easy for local users while improving correctness and extensibility.
...
* Generated code branch: `code/generated-state-005-messaging-nats-replacement`
