...
- [ADR-006 Use PostgreSQL for State 004 Database Replacement](/docs/adr/006-state-004-use-postgres-for-database-replacement)
- [ADR-007 Adopt LGTM + OpenTelemetry Stack for State 006 Baseline](/docs/adr/007-state-006-adopt-lgtm-observability-stack)
- [ADR-008 Convergence State Model (C0-C3)](/docs/adr/008-convergence-state-model)
