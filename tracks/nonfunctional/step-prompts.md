...
- `nf-02-zero-trust` -> `tracks/nonfunctional/steps/02-zero-trust/spec.md`
- `nf-03-observability` -> `tracks/nonfunctional/steps/03-observability/spec.md`
- `nf-04-redis-caching` -> `tracks/nonfunctional/steps/04-redis-caching/spec.md`
- `nf-04-distributed-caching` -> `tracks/nonfunctional/steps/04-distributed-caching/spec.md`
