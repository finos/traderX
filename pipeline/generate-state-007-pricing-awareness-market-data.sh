...
PARENT_STATE_ID="006-observability-lgtm-compose"
...
cat <<'EOF'
[summary] state=007-pricing-awareness-market-data
[summary] parent-state=006-observability-lgtm-compose
...
[summary] runtime-entrypoint=./scripts/start-state-007-pricing-awareness-market-data-generated.sh
EOF
