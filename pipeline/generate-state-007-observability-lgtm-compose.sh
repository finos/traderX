...
PARENT_STATE_ID="006-messaging-nats-replacement"
...
cat <<'EOT'
[summary] state=007-observability-lgtm-compose
[summary] parent-state=006-messaging-nats-replacement
...
[summary] runtime-entrypoint=./scripts/start-state-007-observability-lgtm-compose-generated.sh
EOT
