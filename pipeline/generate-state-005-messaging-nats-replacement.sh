...
STATE_ID="005-messaging-nats-replacement"
PARENT_STATE_ID="004-postgres-database-replacement"
...
cat <<'EOF'
[summary] state=005-messaging-nats-replacement
[summary] parent-state=004-postgres-database-replacement
...
[summary] runtime-entrypoint=./scripts/start-state-005-messaging-nats-replacement-generated.sh
EOF
