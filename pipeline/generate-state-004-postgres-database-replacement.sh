...
STATE_ID="004-postgres-database-replacement"
...
cat <<'EOF'
[summary] state=004-postgres-database-replacement
...
[summary] runtime-entrypoint=./scripts/start-state-004-postgres-database-replacement-generated.sh
EOF
