...
usage() {
  cat <<'EOF'
Usage:
  bash pipeline/speckit/compare-all-component-generation.sh [legacy-ref] [--allow-differences]

Examples:
  bash pipeline/speckit/compare-all-component-generation.sh HEAD
  bash pipeline/speckit/compare-all-component-generation.sh origin/main --allow-differences
EOF
}
