...
describe('PositionBlotterComponent', () => {
  ...
  beforeEach(() => {
    ...
    component.accountPositions = positions;
  ...
  it('should show given positions in the grid', async () => {
    ...
    expect(firstRow.children[0].innerText).toEqual(component.accountPositions[0].security);
    expect(firstRow.children[1].innerText).toEqual(component.accountPositions[0].quantity.toString());
  });
