...
- Transition from `003-containerized-compose-runtime` to `005-messaging-nats-replacement`.
...
- State is ready for implementation phase and subsequent publish to `code/generated-state-005-messaging-nats-replacement`.
