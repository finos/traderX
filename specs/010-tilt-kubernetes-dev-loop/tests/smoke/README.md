# Smoke Tests: 010-tilt-kubernetes-dev-loop

- Primary smoke script: `scripts/test-state-010-tilt-kubernetes-dev-loop.sh`
...
```bash
./scripts/test-state-010-tilt-kubernetes-dev-loop.sh http://localhost:8080 traderx kind traderx-state-004
```
