...
- FR-01201: Baseline flows F1-F6 remain behaviorally compatible with state `010-kubernetes-runtime`.
...
- NFR-01202: Kubernetes remains the runtime substrate inherited from state `010-kubernetes-runtime`.
...
- SC-01203: State topology/docs clearly identify this state as a sibling branch of `011-tilt-kubernetes-dev-loop`.
