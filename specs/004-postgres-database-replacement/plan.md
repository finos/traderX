...
- Transition from `003-containerized-compose-runtime` to `004-postgres-database-replacement`.
...
4. Generation hook implementation in `pipeline/generate-state-004-postgres-database-replacement.sh`.
5. Runtime scripts (`start/stop/status`) for generated state 004.
6. Smoke test implementation in `scripts/test-state-004-postgres-database-replacement.sh`.
...
- State is publishable to `code/generated-state-004-postgres-database-replacement`.
