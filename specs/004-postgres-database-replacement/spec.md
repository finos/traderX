...
**Feature Branch**: `004-postgres-database-replacement`  
**Created**: 2026-03-31  
**Status**: Implemented  
...
- SC-901: `pipeline/generate-state-004-postgres-database-replacement.sh` generates a runnable PostgreSQL-based runtime pack.
- SC-902: `scripts/start-state-004-postgres-database-replacement-generated.sh` starts runtime successfully.
- SC-903: `scripts/test-state-004-postgres-database-replacement.sh` passes core smoke checks.
- SC-904: State catalog points to `code/generated-state-004-postgres-database-replacement`.
