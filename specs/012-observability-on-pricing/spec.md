...
**Feature Branch**: `012-observability-on-pricing`  
**Created**: 2026-04-05  
**Status**: Implemented  
**Input**: Transition delta from `010-pricing-awareness-market-data`
...
- SC-01201: `./scripts/start-state-012-observability-on-pricing-generated.sh` starts app + observability stack successfully.
- SC-01202: `./scripts/test-state-012-observability-on-pricing.sh` validates observability endpoints, probe targets, and inherited pricing behavior.
