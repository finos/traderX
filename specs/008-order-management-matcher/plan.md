# Implementation Plan: 008-order-management-matcher

## Scope

- Transition from `007-pricing-awareness-market-data` to `008-order-management-matcher`.
...
6. Generation hook implementation in `pipeline/generate-state-008-order-management-matcher.sh`.
7. Smoke test implementation in `scripts/test-state-008-order-management-matcher.sh`.
...
- State can be published to `code/generated-state-008-order-management-matcher`.
