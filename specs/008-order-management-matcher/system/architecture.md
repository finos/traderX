...
| `app_runtime` | boundary | TraderX App Runtime | State 008 pricing/runtime baseline with order-management extensions. |
| `obs_runtime` | boundary | Observability Runtime | LGTM + OTel stack from state 006 carried forward with order telemetry coverage. |
