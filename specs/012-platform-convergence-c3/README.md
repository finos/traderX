...
This pack defines the C3 convergence checkpoint. It keeps single-parent publish lineage through state `011`, while recording convergence from C2 functional capability (`009`) via dotted-line lineage.

Primary intent:

- mark the canonical C3 platform convergence state,
- preserve Kubernetes + Tilt platform behavior from `010`,
- preserve C2 functional capability inherited through `011`,
