# Smoke Tests: 012-radius-kubernetes-platform

- Primary smoke script: `scripts/test-state-012-radius-kubernetes-platform.sh`
...
```bash
./scripts/test-state-012-radius-kubernetes-platform.sh http://localhost:8080 traderx kind traderx-state-009
```
