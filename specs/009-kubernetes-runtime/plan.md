...
- Transition from `003-containerized-compose-runtime` to `009-kubernetes-runtime`.
- Track focus: `devex`.
...
5. Generation hook implementation in `pipeline/generate-state-009-kubernetes-runtime.sh`.
...
7. Smoke test implementation in `scripts/test-state-009-kubernetes-runtime.sh`.
...
- State can be published to `code/generated-state-009-kubernetes-runtime`.
