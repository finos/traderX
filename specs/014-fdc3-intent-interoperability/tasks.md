...
- [x] T01420 Include selected Sail demo apps in local directory profile and verify compatibility.
- [ ] T01421 Add E2E verification for TraderX and Sail demo flows.
...
- [x] T01426 Move TradingView symbol-format compatibility logic into Sail-side override assets and keep TraderX outbound payload canonical (`ticker` only).
