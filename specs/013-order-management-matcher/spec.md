...
**Feature Branch**: `013-order-management-matcher`  
**Created**: 2026-04-05  
**Status**: Planned  
**Input**: Transition delta from `012-observability-on-pricing`
...
- FR-01307: Existing pricing + trade + position flows from state `012` remain compatible unless explicitly changed in this pack.

## Non-Functional Requirements

- NFR-01301: Observability stack from `012` remains intact and now covers order-management components and endpoints.
...
- SC-01301: Generation hook exists and is runnable (`pipeline/generate-state-013-order-management-matcher.sh`).
- SC-01302: State smoke test path is defined (`scripts/test-state-013-order-management-matcher.sh`).
