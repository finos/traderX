# Non-Functional Delta: 013-order-management-matcher

Parent state: `012-observability-on-pricing`

Document NFR changes introduced by this state.

## Runtime / Operations

- Keep LGTM stack from `012` (Grafana, Prometheus, Loki, Tempo, OTel Collector, Promtail, Blackbox Exporter).
