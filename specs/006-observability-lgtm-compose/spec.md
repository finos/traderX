...
- SC-01101: `./scripts/start-state-006-observability-lgtm-compose-generated.sh` brings up app + observability stack successfully.
- SC-01102: `./scripts/test-state-006-observability-lgtm-compose.sh` validates observability endpoints, dashboard provisioning, and baseline functional flow.
