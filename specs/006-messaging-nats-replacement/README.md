...
- Runtime base remains Docker Compose and NGINX ingress from `004`.
...
- ADR: [`docs/adr/005-state-006-use-nats-for-messaging-replacement.md`](/docs/adr/005-state-006-use-nats-for-messaging-replacement)
