...
**Feature Branch**: `006-messaging-nats-replacement`  
**Created**: 2026-03-31  
**Status**: Planned  
**Input**: Transition delta from `005-postgres-database-replacement`
...
- FR-704: Existing user-visible baseline flows from state `005` (trade submit, blotter/position updates, account workflows) SHALL remain behaviorally compatible.
