...
MINIKUBE_PROFILE="${4:-${MINIKUBE_PROFILE:-traderx-state-009}}"
...
echo "[check] state 009 ingress-routed service smoke suite"
...
echo "[done] state 009 kubernetes runtime smoke tests passed"
