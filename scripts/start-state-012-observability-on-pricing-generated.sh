...
COMPOSE_DIR="${REPO_ROOT}/generated/code/target-generated/observability-on-pricing"
...
bash "${REPO_ROOT}/scripts/star-grafana-traderx-dashboards.sh" \
  ...
  "admin" \
  "TraderX" \
  "traderx-obs-012-pricing" || true

echo "[done] state 012 observability+pricing runtime started"
